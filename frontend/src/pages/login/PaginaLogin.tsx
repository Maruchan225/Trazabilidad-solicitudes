...
import type { CredencialesLogin } from '@/types/autenticacion';
    ...
    <div className="flex min-h-screen items-center justify-center bg-municipal px-4 py-10">
      <Card className="w-full max-w-md rounded-[32px] shadow-panel" bordered={false}>
        <Space direction="vertical" size={20} className="w-full">
          <div>
            <Typography.Text className="!uppercase !tracking-[0.2em] !text-municipal-500">
              Acceso Interno
            </Typography.Text>
            <Typography.Title level={2} className="!mb-2 !mt-3 !text-municipal-900">
              Trazabilidad Municipal
            </Typography.Title>
            <Typography.Paragraph className="!mb-0 !text-municipal-700">
          ...
          <Form layout="vertical" size="large" onFinish={manejarEnvio}>
            ...
            >
              <Input prefix={<UserOutlined />} placeholder="encargado@demo.cl" />
            </Form.Item>
            <Form.Item
              label="Contrasena"
              name="contrasena"
